...
vessels_WM = table(mean(tmp1(:,:,2),1)'*100,...
    ...
    {'T1_nG1','T1_nG2','T12_nG1','T12_nG2'});
writetable(vessels_GM,fullfile(export_folder,'Not_WhiteMatter_vessels.csv'))

vessels_GM = table(mean(tmp1(:,:,3),1)'*100,...
    mean(tmp2(:,:,3),1)'*100, mean(tmp3(:,:,3),1)'*100,...
    mean(tmp4(:,:,3),1)'*100, 'VariableNames', ...
    {'T1_nG1','T1_nG2','T12_nG1','T12_nG2'});
writetable(vessels_GM,fullfile(export_folder,'Not_CSF_vessels.csv'))
...
vessels_WM = table(mean(tmp1(:,:,2),1)'*100,...
    ...
    mean(tmp4(:,:,2),1)'*100, 'VariableNames', ...
    {'T1_nG1','T1_nG2','T12_nG1','T12_nG2'});
writetable(vessels_GM,fullfile(export_folder,'WhiteMatter_vessels.csv'))

vessels_GM = table(mean(tmp1(:,:,3),1)'*100,...
    mean(tmp2(:,:,3),1)'*100, mean(tmp3(:,:,3),1)'*100,...
    mean(tmp4(:,:,3),1)'*100, 'VariableNames', ...
    {'T1_nG1','T1_nG2','T12_nG1','T12_nG2'});
writetable(vessels_GM,fullfile(export_folder,'CSF_vessels.csv'))
